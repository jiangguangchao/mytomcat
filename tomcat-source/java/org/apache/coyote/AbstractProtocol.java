...
public abstract class AbstractProtocol<S> implements ProtocolHandler,
    ...
    protected static class ConnectionHandler<S> implements AbstractEndpoint.Handler<S> {
        ...
        public SocketState process(SocketWrapperBase<S> wrapper, SocketEvent status) {
            ...
            //jgctodo
            System.out.println("handler对象开始处理请求");
            ...
            //jgctodo
            System.out.println("获取到socket对应的processor对象：" + processor);
            ...
            try {
                if (processor == null) {
                    ...
                    if (negotiatedProtocol != null && negotiatedProtocol.length() > 0) {
                        ...
                        if (upgradeProtocol != null) {
                            //jgctodo
                            System.out.println("processor赋值1");
                ...
                if (processor == null) {
                    //jgctodo
                    System.out.println("processor赋值2");
                ...
                if (processor == null) {
                    //jgctodo
                    System.out.println("processor赋值3");
                ...
                do {
                    ...
                    //jgctodo
                    System.out.println("Excutor中调用process 前 state：" + state + ", processor" + processor);
